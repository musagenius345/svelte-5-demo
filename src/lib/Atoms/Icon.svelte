<script>
  ...
  let { github, twitter, clipboard, cross, chevron, tick } = $props()
  import IconStyles from './IconStyles.svelte'
  // TODO add colorState to a store
  let colorState
</script>
<div style:display="content">
  {#if clipboard}
    <IconStyles xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"> 
...
{/if}
{#if github}
    <IconStyles xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" aria-hidden="true">
...
{#if chevron}
    <IconStyles xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20" aria-hidden="true">
